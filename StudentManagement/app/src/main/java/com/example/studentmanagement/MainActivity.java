...
public class MainActivity extends AppCompatActivity {
    ...
    SimpleAdapter sa;
    com.example.studentmanagement.DBHelper dbh;
    SQLiteDatabase db;
    Cursor cursor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbh=new com.example.studentmanagement.DBHelper(this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ab=new AlertDialog.Builder(com.example.studentmanagement.MainActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id==R.id.nav_search){
            Intent intent =new Intent(com.example.studentmanagement.MainActivity.this, com.example.studentmanagement.SearchActivity.class);
            startActivity(intent);
            return true;

        }else if (id==R.id.nav_add){
            Intent intent =new Intent(com.example.studentmanagement.MainActivity.this, com.example.studentmanagement.AddContact.class);
            startActivity(intent);
            return true;

        }else if (id==R.id.nav_delete){
            Intent intent =new Intent(com.example.studentmanagement.MainActivity.this, com.example.studentmanagement.delete.class);
            startActivity(intent);
            return true;
